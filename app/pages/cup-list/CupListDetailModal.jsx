...
const CupListDetailModal = forwardRef((props, ref) => {
					...
					<Card blurOptions padding-20 onPress={() => close()}>
						<View gap-5>
							...
							<View row>
								<View flex center>
									<Text>Vendor</Text>
									<Text text60BO>{cupListData.current.vendor_name ?? "-"}</Text>
								</View>
								<View flex center>
									<Text>Created By</Text>
									<Text text60BO>{cupListData.current.user_name ?? "-"}</Text>
								</View>
							</View>
							<Divider />
							<View row>
								...
								<View flex center>
									<Text>Amount</Text>
									<Text text60BO>{cupListData.current.total_price}</Text>
								</View>
							</View>
							<Divider />
							<View row>
...
export default CupListDetailModal;
